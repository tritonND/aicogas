            ...
            <div class="col-sm-8">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Admin Dashboard: Ugbowo Customers </h4>
                         ...
                         <a href=\"php/ugphone.php\">  <button  id=\"newv\" name=\"newv\" class=\"btn  btn-primary\"> Export Phone Numbers</button> </a>
                                </div>
                            </div>";
                            }
                            ?>
                            ...
                            <div class="content table-responsive" >
                                ...
                                <div id="chartActivity" class="ct-chart ">
                                    <table id="myTable"  class="table table-responsive table-condensed table-striped table-bordered table-hover">
                                        ...
                                        $query = "SELECT * FROM ug ORDER BY id DESC";
