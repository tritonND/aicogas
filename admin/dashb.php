        ...
        <div class="row">
            <div class="col-sm-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    ?>
                    <li role="presentation" class="active"><a href="php/logout.php">Log Out</a></li>

                    <!--
                    <li role="presentation" class="active"><a href="#">View Customers</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            if($_SESSION['user'] =="ADMIN")
                            {
                                ...
                                <div class=\"col-sm-5\"> </div>
                                <div class=\" col-md-5 col-md-offset-5\">
                                    <button data-toggle=\"modal\" data-target=\"#aview-modal2\" id=\"newEnt\" name=\"newEnt\" class=\"btn  btn-primary\"> New Entry</button>
                                </div>
...
SELECT cnum, name, phone,addr, REGDATE FROM ug";
                                        ...
                                        while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-target="#view-modal" data-id="<?php echo $row['cnum']; ?>" id="getUser1" class="btn btn-sm btn-info"> View</button>
                                                </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="modalid" class="table table-striped table-bordered">
                                        <tr>
                                            <th>Card Number</th>
                                            <td id="txt_email"></td>
                                        </tr>
...
<div id="aview-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <form name="modform" id="modform">
            <div class="modal-content">
    ...
    <div class="modal-dialog">
        <form name="modform" id="modform">
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: #8c8c8c">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" align="center" style="color: #ffffff">
                        AICO Gas New Customer Entry
                    </h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="ignores" data-dismiss="modal">Cancel</button>
...
<div id="aview-modal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <form name="modform" id="modform">
            <div class="modal-content">
                                            ...
                                            <form id="entryform" method="POST" role="form" data-toggle="validator" onsubmit="return false;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <div class=" input-group margin-bottom-sm">
                                                            <span class="input-group-addon"> <i class="fa fa-fw"></i></span>
                                                            <input type="text" class="form-control" pattern=".{4,}" title="Minimum of 5 Characters required" id="cnum" name="cnum" >
                                                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="ignores" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" id="treaty" name="atreaty">Submit</button>
                </div>
