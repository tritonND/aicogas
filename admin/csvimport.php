        ...
        <div class="row">
            <div class="col-sm-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <!--
                      <li role="presentation" class="active"><a href="php/csvexp.php">Export Data</a></li>
                            ...
                            <div class="content table-responsive" >
                                ...
                                <div id="chartActivity" class="ct-chart ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <form class="form-horizontal" action="php/functionsar.php" method="post" name="upload_excel" enctype="multipart/form-data">
                                                <fieldset>

                                                    <!-- Form Name -->
                                                    <legend>Upload Airport Road Customers Data</legend>
                                            ...
                                            <form class="form-horizontal" action="php/functionsad.php" method="post" name="upload_excel" enctype="multipart/form-data">
                                                <fieldset>

                                                    <!-- Form Name -->
                                                    <legend>Upload Aduwawa Customers Data</legend>
                                            ...
                                            <form class="form-horizontal" action="php/functionsug.php" method="post" name="upload_excel" enctype="multipart/form-data">
                                                <fieldset>

                                                    <!-- Form Name -->
                                                    <legend>Upload Ugbowo Customers Data</legend>
